...
public class MaskUtil {
    ...
    // Aviso: pode ocorrer erro de login. Deve ser testado se não ocorre algo de cpf/senha inválidos agora que a mascarramento e o algoritmo
    // de validação está feito.
}